...
class UserManagementApprovalTest extends TestCase
{
     ...
     *   ⚠ **順序を誤っても「送り直せなくなる」画面は、通常の遷移ではどこにも無い**（design doc
     *   §5.12・2026-09-17 Task 13 実測 —— **CSV の確定でさえ**同じ鍵を再掲しない。`preview()` が
     ...
     *   「戻る」で送信前の古いページ（古い guide_token を hidden に持つ）へ復元し、そこから
     *   送るような経路までは検証していない。
