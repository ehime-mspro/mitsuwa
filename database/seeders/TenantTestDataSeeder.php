...
class TenantTestDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 用途マスターIDを取得（InquiryUsageTypeSeeder実行済み前提）
        $usageTypes = InquiryUsageType::pluck('id', 'name');

        // --- ○○ビル（3階×2区画 = 6区画）---
        $u_m_3a = Unit::create(['property_id' => $properties['marumaru']->id, 'floor' => 3, 'room_number' => 'A', 'display_name' => '3A', 'area_tsubo' => 15.3, 'usage_type_id' => $usageTypes['事務所'],    'status' => 'occupied',     'rent' => 190000, 'common_fee' => 15000, 'deposit' => 380000, 'garbage_fee' => 3000, 'pest_control_fee' => 0]);
        $u_m_3b = Unit::create(['property_id' => $properties['marumaru']->id, 'floor' => 3, 'room_number' => 'B', 'display_name' => '3B', 'area_tsubo' => 14.8, 'usage_type_id' => $usageTypes['事務所'],    'status' => 'vacant',       'rent' => 190000, 'common_fee' => 15000, 'deposit' => 380000, 'garbage_fee' => 3000, 'pest_control_fee' => 0]);
        $u_m_2a = Unit::create(['property_id' => $properties['marumaru']->id, 'floor' => 2, 'room_number' => 'A', 'display_name' => '2A', 'area_tsubo' => 16.0, 'usage_type_id' => $usageTypes['店舗'],      'status' => 'occupied',     'rent' => 160000, 'common_fee' => 12000, 'deposit' => 320000, 'garbage_fee' => 0,    'pest_control_fee' => 2000]);
        $u_m_2b = Unit::create(['property_id' => $properties['marumaru']->id, 'floor' => 2, 'room_number' => 'B', 'display_name' => '2B', 'area_tsubo' => 15.5, 'usage_type_id' => $usageTypes['店舗'],      'status' => 'negotiating',  'rent' => 160000, 'common_fee' => 12000, 'deposit' => 320000, 'garbage_fee' => 0,    'pest_control_fee' => 2000]);
        $u_m_1a = Unit::create(['property_id' => $properties['marumaru']->id, 'floor' => 1, 'room_number' => 'A', 'display_name' => '1A', 'area_tsubo' => 25.0, 'usage_type_id' => $usageTypes['店舗'],      'status' => 'occupied',     'rent' => 300000, 'common_fee' => 20000, 'deposit' => 600000, 'garbage_fee' => 5000, 'pest_control_fee' => 2000]);
        $u_m_1b = Unit::create(['property_id' => $properties['marumaru']->id, 'floor' => 1, 'room_number' => 'B', 'display_name' => '1B', 'area_tsubo' => 22.0, 'usage_type_id' => $usageTypes['店舗'],      'status' => 'occupied',     'rent' => 280000, 'common_fee' => 18000, 'deposit' => 560000, 'garbage_fee' => 4000, 'pest_control_fee' => 0]);

        // --- △△ビル（2階×2区画 = 4区画）---
        $u_s_2a = Unit::create(['property_id' => $properties['sankaku']->id, 'floor' => 2, 'room_number' => 'A', 'display_name' => '2A', 'area_tsubo' => 18.0, 'usage_type_id' => $usageTypes['事務所'], 'status' => 'occupied', 'rent' => 170000, 'common_fee' => 13000, 'deposit' => 340000, 'garbage_fee' => 3000, 'pest_control_fee' => 0]);
        $u_s_2b = Unit::create(['property_id' => $properties['sankaku']->id, 'floor' => 2, 'room_number' => 'B', 'display_name' => '2B', 'area_tsubo' => 17.5, 'usage_type_id' => $usageTypes['事務所'], 'status' => 'vacant',   'rent' => 165000, 'common_fee' => 13000, 'deposit' => 330000, 'garbage_fee' => 3000, 'pest_control_fee' => 0]);
        $u_s_1a = Unit::create(['property_id' => $properties['sankaku']->id, 'floor' => 1, 'room_number' => 'A', 'display_name' => '1A', 'area_tsubo' => 20.0, 'usage_type_id' => $usageTypes['店舗'],   'status' => 'occupied', 'rent' => 220000, 'common_fee' => 15000, 'deposit' => 440000, 'garbage_fee' => 4000, 'pest_control_fee' => 2000]);
        $u_s_1b = Unit::create(['property_id' => $properties['sankaku']->id, 'floor' => 1, 'room_number' => 'B', 'display_name' => '1B', 'area_tsubo' => 19.0, 'usage_type_id' => $usageTypes['店舗'],   'status' => 'occupied', 'rent' => 200000, 'common_fee' => 15000, 'deposit' => 400000, 'garbage_fee' => 4000, 'pest_control_fee' => 0]);

        // --- □□ビル（2階×2区画 = 4区画）---
        $u_q_2a = Unit::create(['property_id' => $properties['shikaku']->id, 'floor' => 2, 'room_number' => 'A', 'display_name' => '2A', 'area_tsubo' => 12.0, 'usage_type_id' => $usageTypes['倉庫'], 'status' => 'occupied', 'rent' => 100000, 'common_fee' => 8000, 'deposit' => 200000, 'garbage_fee' => 2000, 'pest_control_fee' => 0]);
        $u_q_2b = Unit::create(['property_id' => $properties['shikaku']->id, 'floor' => 2, 'room_number' => 'B', 'display_name' => '2B', 'area_tsubo' => 12.0, 'usage_type_id' => $usageTypes['倉庫'], 'status' => 'vacant',   'rent' => 100000, 'common_fee' => 8000, 'deposit' => 200000, 'garbage_fee' => 2000, 'pest_control_fee' => 0]);
        $u_q_1a = Unit::create(['property_id' => $properties['shikaku']->id, 'floor' => 1, 'room_number' => 'A', 'display_name' => '1A', 'area_tsubo' => 14.0, 'usage_type_id' => $usageTypes['店舗'],      'status' => 'occupied', 'rent' => 130000, 'common_fee' => 10000, 'deposit' => 260000, 'garbage_fee' => 3000, 'pest_control_fee' => 0]);
        $u_q_1b = Unit::create(['property_id' => $properties['shikaku']->id, 'floor' => 1, 'room_number' => 'B', 'display_name' => '1B', 'area_tsubo' => 13.5, 'usage_type_id' => $usageTypes['店舗'],      'status' => 'vacant',   'rent' => 125000, 'common_fee' => 10000, 'deposit' => 250000, 'garbage_fee' => 3000, 'pest_control_fee' => 0]);

        // --- ☆☆ビル（非稼働・4区画すべて空室）---
        Unit::create(['property_id' => $properties['hoshi']->id, 'floor' => 2, 'room_number' => 'A', 'display_name' => '2A', 'area_tsubo' => 10.0, 'usage_type_id' => $usageTypes['店舗'], 'status' => 'vacant', 'rent' => 0, 'common_fee' => 0, 'deposit' => 0, 'garbage_fee' => 0, 'pest_control_fee' => 0]);
        Unit::create(['property_id' => $properties['hoshi']->id, 'floor' => 2, 'room_number' => 'B', 'display_name' => '2B', 'area_tsubo' => 10.0, 'usage_type_id' => $usageTypes['店舗'], 'status' => 'vacant', 'rent' => 0, 'common_fee' => 0, 'deposit' => 0, 'garbage_fee' => 0, 'pest_control_fee' => 0]);
        Unit::create(['property_id' => $properties['hoshi']->id, 'floor' => 1, 'room_number' => 'A', 'display_name' => '1A', 'area_tsubo' => 10.0, 'usage_type_id' => $usageTypes['店舗'], 'status' => 'vacant', 'rent' => 0, 'common_fee' => 0, 'deposit' => 0, 'garbage_fee' => 0, 'pest_control_fee' => 0]);
        Unit::create(['property_id' => $properties['hoshi']->id, 'floor' => 1, 'room_number' => 'B', 'display_name' => '1B', 'area_tsubo' => 10.0, 'usage_type_id' => $usageTypes['店舗'], 'status' => 'vacant', 'rent' => 0, 'common_fee' => 0, 'deposit' => 0, 'garbage_fee' => 0, 'pest_control_fee' => 0]);

        // --- ◇◇テナント（平屋型・3区画）---
        $u_h_a = Unit::create(['property_id' => $properties['hira']->id, 'floor' => null, 'room_number' => 'A', 'display_name' => 'A', 'area_tsubo' => 13.0, 'usage_type_id' => $usageTypes['店舗'], 'status' => 'occupied', 'rent' => 120000, 'common_fee' => 8000, 'deposit' => 240000, 'garbage_fee' => 2000, 'pest_control_fee' => 0]);
        $u_h_b = Unit::create(['property_id' => $properties['hira']->id, 'floor' => null, 'room_number' => 'B', 'display_name' => 'B', 'area_tsubo' => 12.0, 'usage_type_id' => $usageTypes['店舗'], 'status' => 'vacant',   'rent' => 100000, 'common_fee' => 8000, 'deposit' => 200000, 'garbage_fee' => 0,    'pest_control_fee' => 0]);
        $u_h_c = Unit::create(['property_id' => $properties['hira']->id, 'floor' => null, 'room_number' => 'C', 'display_name' => 'C', 'area_tsubo' => 14.0, 'usage_type_id' => $usageTypes['店舗'], 'status' => 'occupied', 'rent' => 130000, 'common_fee' => 8000, 'deposit' => 260000, 'garbage_fee' => 2000, 'pest_control_fee' => 0]);
