    ...
    <form method="POST" action="{{ route('housing.contracts.update-custom-order', $hsCustomOrder) }}">
        ...
        <div class="hc-card">
            ...
            <div class="hc-field-row">
                <div class="hc-field">
                    ...
                    <input type="text" name="customer_name" value="{{ old('customer_name', $hsCustomOrder->customer_name) }}" class="hc-input">
                ...
                <div class="hc-field">
                    ...
                    <select name="customer_id" class="hc-select">
                        ...
                        @foreach($buyers as $buyer)
                            <option value="{{ $buyer->id }}" @selected(old('customer_id', $hsCustomOrder->customer_id) == $buyer->id)>
        ...
        <div class="hc-card">
            ...
            <div class="hc-field" style="max-width: 50%;">
                ...
                <div class="hc-input-group">
                    <input type="number" name="tax_rate" value="{{ old('tax_rate', $hsCustomOrder->tax_rate) }}" step="0.01" class="hc-input">
