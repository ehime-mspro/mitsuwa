            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr>
                        ...
                        <th class="px-3 py-2.5 text-xs font-semibold text-gray-600 bg-gray-50 border-b-2 border-gray-200 whitespace-nowrap" style="text-align: right; padding-right: 55px;">請負金額</th>
