...
<div x-data="usageTypeManager()">
        ...
        <table class="w-full" style="table-layout: fixed;">
            ...
            <thead>
                <tr class="bg-gray-50 border-b border-gray-200">
                    ...
                    <th class="text-xs font-semibold text-gray-600 text-left py-2.5 px-3">用途名</th>
            ...
            <tbody>
                ...
                <tr x-show="adding" class="border-b border-gray-100 bg-emerald-50/30">
                    ...
                    <td class="py-2.5 px-3">
                        <input type="text" x-model="newName" placeholder="用途名を入力"
                               class="w-full px-3 border border-emerald-400 rounded-md text-sm text-gray-800 focus:border-emerald-500 focus:outline-none"
                               style="height:36px;"
                               x-ref="newNameInput"
    ...
    {{-- 非表示フォーム: 新規追加 --}}
    <form x-ref="addForm" method="POST" action="{{ route('admin.master.usage-types.store') }}" class="hidden">
        @csrf
...
<script>
function usageTypeManager() {
    return {
        items: @json($usageTypesForJs),
        editingId: null,
        editingName: '',
        deletingId: null,
        deletingName: '',
        ...
        dragOverIndex: null,
        reorderMessage: '',
        baseUrl: '{{ url("/admin/master/usage-types") }}',
