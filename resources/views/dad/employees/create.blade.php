...
<div class="flex items-center justify-between mb-4">
    <h1 class="text-lg max-lg:text-base font-bold text-gray-900">従業員 新規登録</h1>
...
<form method="POST" action="{{ route('dad.employees.store') }}" style="max-width: 1000px;">
    @csrf

    @include('dad.employees._form', ['employee' => null])

    <div style="display: flex; justify-content: flex-end; gap: 8px;">
        <a href="{{ route('dad.employees.index') }}" style="display: inline-flex; align-items: center; padding: 10px 20px; border: 1px solid #d1d5db; border-radius: 6px; background: white; font-size: 14px; color: #374151; text-decoration: none;">キャンセル</a>
