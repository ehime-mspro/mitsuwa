...
<form method="POST" action="{{ route('dad.projects.store') }}">
    ...
    <div style="display: flex; justify-content: flex-end; gap: 8px;">
        <a href="{{ route('dad.projects.index') }}" style="display: inline-flex; align-items: center; padding: 10px 20px; border: 1px solid #d1d5db; border-radius: 6px; background: white; font-size: 14px; color: #374151; text-decoration: none;">キャンセル</a>
