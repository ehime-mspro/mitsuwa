...
function onGoogleMapsReady() {
    ...
    if (savedLat && savedLng) {
        showProcMap(parseFloat(savedLat), parseFloat(savedLng));
    }
}
...
function geocodeAddress() {
    ...
    procGeocoder.geocode({ address: address }, function(results, status) {
