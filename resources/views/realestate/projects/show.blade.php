...
<div x-data="projectDetail()">
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-5 mb-5">
        ...
        <div class="border border-gray-200 rounded-md overflow-hidden" style="display: grid; grid-template-columns: 130px 1fr 130px 1fr;">
            ...
            <dd class="px-3.5 py-2.5 text-sm text-gray-900 border-b border-gray-200">
                @if($project->supplier)
                    <a href="{{ route('realestate.suppliers.show', $project->supplier) }}" class="text-emerald-600 font-medium hover:underline">{{ $project->supplier->supplier_code }} {{ $project->supplier->name }}</a>
                @else
                    <span class="text-gray-400">—</span>
                @endif
            </dd>
            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr>
                        ...
                        <th class="px-3 py-2.5 text-center text-xs font-semibold text-gray-600 bg-gray-50 border-b-2 border-gray-200 whitespace-nowrap">面積</th>
                        <th class="px-3 py-2.5 text-center text-xs font-semibold text-gray-600 bg-gray-50 border-b-2 border-gray-200 whitespace-nowrap">坪数</th>
...
<script src="https://maps.googleapis.com/maps/api/js?key={{ env('GOOGLE_MAPS_API_KEY', '') }}&callback=initDetailMap&language=ja&region=JP" async defer></script>
@endif
