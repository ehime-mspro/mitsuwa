        ...
        <div class="bg-white border border-gray-200 rounded-lg p-5 mb-3">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="floor" value="{{ old('floor', $unit->floor) }}" min="1" max="99"
                ...
                <div>
                    ...
                    <select name="usage_type"
                        ...
                        <option value="shop" {{ old('usage_type', $unit->usage_type?->value) === 'shop' ? 'selected' : '' }}>店舗</option>
                        <option value="warehouse" {{ old('usage_type', $unit->usage_type?->value) === 'warehouse' ? 'selected' : '' }}>倉庫</option>
                        <option value="office" {{ old('usage_type', $unit->usage_type?->value) === 'office' ? 'selected' : '' }}>事務所</option>
                        <option value="other" {{ old('usage_type', $unit->usage_type?->value) === 'other' ? 'selected' : '' }}>その他</option>
                    </select>
                </div>
