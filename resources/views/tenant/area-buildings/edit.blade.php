...
@section('content')
    ...
    <h1 class="text-lg max-lg:text-base font-bold text-gray-900 mb-4">ビル情報の編集</h1>
    ...
    <form method="POST" action="{{ route('tenant.area-buildings.update', $building) }}">
        @csrf
        @method('PUT')
        @include('tenant.area-buildings._form', ['building' => $building])
