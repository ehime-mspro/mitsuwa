...
**決まった値**: 最小幅 900px ・割合 14.3 / 21.6 / 19.4 / 16.4 / 11.7 / 16.6 %（中身に要る幅に比例）。
1200px 幅の表（914px）には最悪ケースの中身（計 926px）が 12px 収まらず、
1200〜1211px の画面でだけ最悪ケースの行の文字が余白に最大 2.7px 食い込む（隣の列とは 17px 以上離れる）。
利用者の判断で許容した（最小幅 930px にしてその幅で表を横スクロールさせる案・余白を 16px に詰める案は採らなかった）。
